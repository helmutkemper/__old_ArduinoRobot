...
unsigned char local_ip[] = {169,254,167,4};	// IP address of Wifi Bee
unsigned char gateway_ip[] = {169,254,167,201};	// router or gateway IP address
unsigned char subnet_mask[] = {255,255,0,0};	// subnet mask for the local Wireless network
const prog_char ssid[] PROGMEM = {"ELETRON"};	// max 32 bytes
