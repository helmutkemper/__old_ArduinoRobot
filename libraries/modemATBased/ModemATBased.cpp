...
void ModemATBased::internetDisconnectToHost ( void ( * vafpExtFuntion ) ( void ) )
{
...
void ModemATBased::internetDataSendByGET ( const String * vapsHost, const String * vapsHostPort, void ( * vafpExtFuntion ) ( void ) )
{
