...
const unsigned char modem_echo_off[6]						 =  { 'A', 'T', 'E', '0', '\r', 0x00 };//OK
const unsigned char modem_echo_off_resposta[12]				 =  { 'A', 'T', 'E', '0', '\r', '\r', '\n', 'O', 'K', '\r', '\n', 0x00 };//OK
const unsigned char modem_echo_on[6]						 =  { 'A', 'T', 'E', '1', '\r', 0x00 };//OK
...
const unsigned char modem_bye[3]							 =  { 26, '\r', 0x00 };




const unsigned char modem_sms_text_mode[8]					 =  { 'C', 'M', 'G', 'F', '=', '1', '\r', 0x00 };//OK
...
const unsigned char modem_sms_send_confg[10]                 =  { 'C', 'M', 'G', 'S', '=', '"', kTelefon, '"', '\r', 0x00 };
const unsigned char modem_sms_send_text[2]                   =  { kMessage, 0x00 };
const unsigned char modem_sms_text_redy_to_send[5]			 =  { '\r', '\n', '>', kAnyWare, 0x00 };
